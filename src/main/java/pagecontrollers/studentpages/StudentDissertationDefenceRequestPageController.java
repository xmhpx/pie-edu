...
public class StudentDissertationDefenceRequestPageController extends StudentPageController {

    public static final String fxmlFileName = "studentDissertationDefenceRequestPage.fxml";
